...
… *(den Rest kannst du genau so belassen wie in deiner Datei, er ist ok)* …

---

Der Punkt ist: **diese Datei verursacht keinen Liquid-Fehler** – das haben wir ja gesehen, der Fehler kam aus `vorlagen/README_Pflegehinweise.md`. Solange die Vorlagen-Datei „ruhiggestellt“ bleibt (umbenennen oder `{% raw %}` drum herum), kannst du deine alte Links-Seite ganz normal verwenden.

Wenn du willst, kann ich dir auch noch den unteren Teil („Sekundärquellen …“) kurz durchschauen und kleine Tippfehler (z. B. das `s` oder den DORIS-Link) dort direkt ausbessern.
...
**Salzburger Chronik – Unglücksfall** Kurzlink: `https://tinyurl.com/Helfenberg2`  
...
**Archiv Leitmeritz** Kurzlink: `matriky.soalitomerice.cz`  
...
**Nationalarchiv Tschechien** Kurzlink: `nacr.cz`  
...
**Tschechien-Online: Ortsnamenverzeichnis (A–Z)** Kurzlink: `tschechien-online.org/...`  
...
**Karte: Kupferberg** Kurzlink: Arcanum-Karte  
