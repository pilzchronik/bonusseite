...
<div class="fact-box">
  <span class="fact-title">Haplogruppe: H41a9</span>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-top: 2rem;">
  <a href="{{ '/dna-migration/' | relative_url }}" style="text-decoration: none;">
    <div style="background: #eef4fb; border-left: 4px solid #1a5f9e; border-radius: 4px; padding: 20px;" onmouseover="this.style.background='#d8eaf7'" onmouseout="this.style.background='#eef4fb'">
      <strong style="color: #1a5f9e;">Väterliche Linie · Animierte Karte</strong>
      <p style="margin: 8px 0 0 0; font-size: 0.9em; color: #555;">
        300.000 Jahre von Zentralafrika bis Abraham Pilz 1590 — mit Eisausdehnung.
      </p>
      <span style="font-size: 0.85em; color: #1a5f9e;">→ Karte öffnen</span>
    </div>
  </a>
  <a href="{{ '/dna-migration-muetterlich/' | relative_url }}" style="text-decoration: none;">
    <div style="background: #f5eefb; border-left: 4px solid #7a3a8a; border-radius: 4px; padding: 20px;" onmouseover="this.style.background='#ead8f5'" onmouseout="this.style.background='#f5eefb'">
      <strong style="color: #7a3a8a;">Mütterliche Linie · Animierte Karte</strong>
      <p style="margin: 8px 0 0 0; font-size: 0.9em; color: #555;">
        Von Ostafrika über den Balkan bis Österreich/Kroatien 450 n. Chr.
      </p>
